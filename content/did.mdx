...
meta:
  ...
  description: DID stands for Dissociative identity disorder. Learn about what it means to have DID.
...
<Definition>
  <DefinitionItem summary="A voice in your head">
    DID is more than a voice in your head. It’s more of someone in your head,
    who is different from you, who can take control of one’s body.
  </DefinitionItem>
  ...
  <DefinitionItem summary="A choice">
    People with DID didn’t choose to have it and are often worried about what
    might cause the other person to come out again.
  </DefinitionItem>
...
<Definition>
  <DefinitionItem summary="One or more distinct personalities">
    There are one or more distinct personalities one has that can come and go as
    they wish. They can appear at any time and disappear at any time, though
    they tend to come out when the person would’ve a flashback.
  </DefinitionItem>
  <DefinitionItem summary="Serious and life changing">
    Being that the person isn’t always in control, it can cause them to worry
    about when the other personality could come out. It adds extra stress, and
    this can worsen things.
  </DefinitionItem>
  <DefinitionItem summary="Forced upon the person">
    A person develops DID due to trauma. So sexual abuse and physical abuse can
    lead to the development of DID, as it allows the person to either not deal
    with the memories or not have to be abused.
  </DefinitionItem>
</Definition>
